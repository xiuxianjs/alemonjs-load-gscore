...
function setTransport(transport) {
	...
	const current = values["alemonjs-load-gscore"] ?? {};
	config.saveValue({
		...values,
...
//#endregion
export { getApiToken, getAutoStart, getBotID, getContainerName, getDataDir, getDockerImage, getGSCoreCoreDir, getGSCoreDir, getGSCoreLogsDir, getGSCoreRepo, getGSCoreURL, getGSCoreVenvDir, getGSCoreVenvPython, getMessageTimeout, getPluginsDir, getPort, getPythonCommand, getRuntimeMode, getStartupTimeout, getTransport, getWSToken, setTransport };