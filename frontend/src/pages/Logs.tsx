...
import { getLogs } from '../api/web-api'
...
export default function Logs() {
  ...
  const load = async (file = viewer.activeFile) => { try { setViewer(await getLogs(file)); setNotice('') } catch (error) { setNotice(error instanceof Error ? error.message : String(error)) } }
